...
export const PRICING_TIERS: Record<UIPricingTier, PricingTierConfig> = {
  free: {
    ...
    features: [
      { id: 'pdf-uploads', name: 'PDF Uploads', description: '5 PDF uploads/day (max 20 pages each)' },
      { id: 'flashcards', name: 'Flashcards', description: '80 flashcards/month' },
      { id: 'revision-hub', name: 'Revision Hub', description: '10 cards saved' },
    ...
    limits: {
      maxPdfUploadsPerDay: 5,
      maxPagesPerPdf: 20,
      maxFlashcardsPerMonth: 80,
      maxRevisionHubCards: 10,
  ...
  pro: {
    ...
    features: [
      { id: 'pdf-uploads', name: 'PDF Uploads', description: '12 PDF uploads/day (max 80 pages each)' },
      { id: 'flashcards', name: 'Flashcards', description: '400 flashcards/month' },
    ...
    limits: {
      maxPdfUploadsPerDay: 12,
      maxPagesPerPdf: 80,
      maxFlashcardsPerMonth: 400,
